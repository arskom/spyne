...
dependencies. As an example, assuming the current version of rpclib is 2.4.8,
you can use the following as dependency string:

* ``rpclib`` if you feel adventurous.
...
instead of having 2.0.0-alpha47, we'll have 2.2.5-alpha.  While the meanings of
these labels are generally well-understood, it won't hurt to clarify them in
the Rpclib context:
